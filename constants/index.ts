...
export const featuredFruits = [
  ...
  },
  {
    ...
    color: (opacity: number) => `rgba(255, 170, 157, ${opacity})`,
  },

  {
    ...
    color: (opacity: number) => `rgba(214, 195, 246, ${opacity})`,
  },

  {
    ...
    color: (opacity: number) => `rgba(255, 163, 120, ${opacity})`,
  },
  {
    name: "Green Apple",
    price: "10.5",
    ...
    color: (opacity: number) => `rgba(139, 243, 139, ${opacity})`,
  },
];
